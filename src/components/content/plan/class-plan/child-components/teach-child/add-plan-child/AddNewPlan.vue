  ...
  <div class="add-new-plan" v-show="isShowAddNewPlan">
    <div class="header">
      ...
      <div class="header-input">
        <Input placeholder="请输入方案名称" v-model="planName" />
      </div>
    </div>
    <div class="body">
      <div class="body-tag">
      ...
      <div class="exact-time-span">
        <TimeSpan @getChangeTime="getChangeTime" />
      </div>
      <div class="add-to-list">
        <Button type="warning" @click.native="addToList">添加至列表</Button>
      </div>
    </div>
    <div class="footer">
      ...
      <div class="operation-buttons">
        <Button type="primary" @click.native="savePlan">保存</Button>
        <Button type="warning" @click.native="cancelAddPlan">取消</Button>
      </div>
    </div>
  </div>
</template>
...
<script>
// ? import components
import TimeSpan from '@common/time-span/TimeSpan'

// ? import mixmins
import addNewPlanMix from './addNewPlanMix'
